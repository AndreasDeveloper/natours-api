...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5kcmVhc2RldiIsImEiOiJjankxbTltOTIwZGF4M2JsaGR3dWp0ZnU4In0.kQ74cL2Uj7XY8KB9I0FPvw'; // Setting Up Map
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Add map box marker
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status === 'success') location.reload(true); // true - reload from server, not the browser cache
...
var stripe = Stripe('pk_test_C6zIlfBGWa7JVoHwvUtU7ssR00cXuRurZh'); // Function for booking tours
...
var bookBtn = document.getElementById('book-tour'); // -- Map box setup -- \\
// Delegation

if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations); // Getting locations from dataset
...
if (logoutBtn) logoutBtn.addEventListener('click', _login.logout); // Event Listener on submission of a form | Updating user data
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              document.querySelector('.btn--save-password').textContent = 'Save password'; // Clearing input fields
...
} // Event Listener on click of a button | Booking tour


if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing..'; // Getting tour ID from dataset
